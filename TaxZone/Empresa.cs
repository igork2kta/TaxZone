...
namespace TaxZone
{
    public static class Empresa
    {
        ...
        public static BancoDTO GetBancoFar(string empresa)
        {
            ...
            {
                case "EMR":
                    return new BancoDTO("COM_MGR_ES", "CFLCL");
                case "ESE":
                    return new BancoDTO("COM_SER_ES", "ENERGIPE");
                case "EPB":
                    return new BancoDTO("COM_PAB_ES", "SAELPA");
                case "ETO":
                    return new BancoDTO("COM_TOC_ES", "FARETO");
                case "EMT":
                    return new BancoDTO("COM_MTN_ES", "FAREMT");
                case "EMS":
                    return new BancoDTO("COM_MTS_ES", "FAREMS");
                case "ESS":
                    return new BancoDTO("COM_SPR_ES", "FARESS");
                case "ERO":
                    return new BancoDTO("COM_RON_ES", "FARERO");
                case "EAC":
                    return new BancoDTO("COM_ACR_ES", "FAREAC");
                default:
                    return null;
            }
        }

        public static BancoDTO GetBancoMsa(string empresa)
        {
            switch (empresa)
            {
                case "EMR":
                    return new BancoDTO("MSA_CRP_PR", "MSFEMG");
                case "ESE":
                    return new BancoDTO("MSA_CRP_PR", "MSFESE");
                case "EPB":
                    return new BancoDTO("MSA_CRP_PR", "MSFEPB");
                case "ETO":
                    return new BancoDTO("MSA_CRP_PR", "MSFETO");
                case "EMT":
                    return new BancoDTO("MSA_CRP_PR", "MSFEMT");
                case "EMS":
                    return new BancoDTO("MSA_CRP_PR", "MSFEMS");
                case "ESS":
                    return new BancoDTO("MSA_CRP_PR", "MSFESS");
                case "ERO":
                    return new BancoDTO("MSA_CRP_PR", "MSFERO");
                case "EAC":
                    return new BancoDTO("MSA_CRP_PR", "MSFEAC");
                default:
                    return null;
            }
        }
